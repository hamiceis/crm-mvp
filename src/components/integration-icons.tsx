...
export function IconWebhook({
  ...
  return (
    ...
    >
      ...
      <line x1="6" x2="9" y1="9" y2="12" />
    </svg>
  );
}

export function IconGoogleCalendar({
  className,
  ...props
}: React.SVGProps<SVGSVGElement>) {
  return (
...
export function IconZapier({
  ...
  return (
    <svg
      ...
      viewBox="0 0 24 24"
      fill="currentColor"
      className={cn("text-[#FF4A00]", className)}
      {...props}
    >
      <path d="M22.9 8.953c-.352-.352-1.04-.6-2.102-.75L12 6.75l-4.148-.5c-1.055-.15-1.75-.398-2.102-.75a1.8 1.8 0 0 1-.5-1.3C5.25 2.1 7.2 0 12 0c4.8 0 6.75 2.1 6.75 4.2 0 .902-.246 1.602-.5 2.152l-.4.8-1.098 1.05L21 8.95c1.05.15 1.75.398 2.102.75.352.352.5.852.5 1.3 0 2.1-1.95 4.2-6.75 4.2-4.8 0-6.75-2.1-6.75-4.2 0-.902.246-1.602.5-2.152l.4-.8 1.098-1.05-4.25-.75c-1.05-.15-1.75-.4-2.102-.75A1.8 1.8 0 0 1 5.25 4.2C5.25 2.1 7.2 0 12 0c4.8 0 6.75 2.1 6.75 4.2 0 .902-.246 1.602-.5 2.152l-.4.8-1.098 1.05L21 8.95Z" />
    </svg>
  );
}
...
export function IconSlack({
  ...
  return (
    <svg
      ...
      viewBox="0 0 24 24"
      fill="currentColor"
      className={cn("text-[#E01E5A]", className)}
      {...props}
    >
...
export function IconGoogleSheets({
  className,
  ...props
}: React.SVGProps<SVGSVGElement>) {
  return (
    <svg
      ...
      strokeLinecap="round"
      strokeLinejoin="round"
      className={cn("text-[#0F9D58]", className)}
      {...props}
    >
